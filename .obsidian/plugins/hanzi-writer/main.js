...
// src/main.ts
var HanziWriterPlugin = class extends import_obsidian.Plugin {
  async onload() {
  ...
  handleHanziWriter(source, el, ctx) {
    ...
    try {
      ...
      const options = {
        ...
        showOutline: config.showOutline !== void 0 ? config.showOutline : false,
        strokeAnimationSpeed: config.strokeAnimationSpeed || 1,
        delayBetweenStrokes: config.delayBetweenStrokes || 1e3,
      ...
      const writer = index_esm_default.create(target, character, options);
